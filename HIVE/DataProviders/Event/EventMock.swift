...
struct EventMock {
  ...
  let eventA = EventModel(minAge: 10, isPrivate: false,pendingParticipants: ParticipantMock.instance.pendingParticipants, _id: "1", eventImageUrl: "event", name: "Mingle After Work ", location: "Ekkamai, St.889", startDate: "2024-10-21", endDate: "2024-10-21", startTime: "08:00", endTime: "10:00", maxParticipants: 100, category: ["tech","business"], additionalInfo: "Hello this is test data for the event.", participants: ParticipantMock.instance.participants, organizer: OrganizerMock.instance.organizer)
